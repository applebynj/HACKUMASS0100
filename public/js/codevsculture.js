...
document.addEventListener('DOMContentLoaded', function () {
    ...
    stack.on('throwout', function (e) {
        ...
        //console.log("this one" + e.target.className + " less " + cardClass.substring(0,2));

        if((cardClass.substring(0,2) == "cu") && (e.throwDirection == 1)) {
          e.target.style.borderColor = "green";
          //console.log("1");
        }
        else if((cardClass.substring(0,2) == "co") && (e.throwDirection == -1)) {
            e.target.style.borderColor = "green";
